    ...
    <AppLayout title="About" showBack>
      <div className="space-y-6 pb-12 max-w-xl mx-auto font-sans">
        ...
        <section className="text-center py-6">
          <div className="w-20 h-20 rounded-3xl bg-cyan-500/10 border border-cyan-400/20 flex items-center justify-center mx-auto text-cyan-600 dark:text-cyan-400 mb-3">
        ...
        <section className="glass-card-light dark:glass-card p-6 rounded-2xl border border-slate-200 dark:border-white/10 space-y-3">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            Designed and built by <span className="font-bold text-slate-800 dark:text-white">Team AQUAID</span>, consisting of senior application architects, computer vision specialists, and marine conservation advocates working to expand global access to oceanic data.
          </p>
        </section>
